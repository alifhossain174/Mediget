                    ...
                    <div class="auth-card">
                        <div class="auth-card-head">
                            <div class="auth-card-head-icon">
                                <img src="{{ url('assets') }}/img/icon/edit.svg" alt="Registration" />
                            </div>
                                ...
                                @if ($socialLogin->gmail_login_status)
                                    ...
                                    <div class="auth-card-google-btn">
                                        <a target="_blank" href="{{ url('auth/google') }}">
                                            <img src="{{ url('assets') }}/img/icon/google.svg" alt="Google" />
    ...
    <div id="confirmation-email-modal">
        ...
        <div class="c-email-modal-content">
            ...
            <div class="c-email-modal-buttons">
                ...
                <a href="javascript:void(0)" class="single-c-email-modal-btn confirm" onclick="submitRegistrationForm()">Yes, confirm</a>
            </div>
        </div>
    </div>
