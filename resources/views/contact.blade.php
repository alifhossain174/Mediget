...
@section('content')
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">
                                    @php
                                        $contactNumbers = '';
                                        foreach (explode(',', $contactInfo->contact) as $contact) {
                                            $contactNumbers .= "<a href='tel:" . $contact . "'>" . $contact . '</a><br>';
                                        }
                                    @endphp
                                    {!! $contactNumbers !!}
                                </p>
                                ...
                                <p class="contact__info--content__desc text-white">
                                    @php
                                        ...
                                        foreach (explode(',', $contactInfo->email) as $email) {
                                            $emailIds .= "<a href='mailto:" . $email . "'>" . $email . '</a><br>';
                                        }
                                    @endphp
                                    {!! $emailIds !!}
                                </p>
    ...
    @if($mapInfo->google_map_link)
    <div class="contact__map--area pt-0">
        <iframe class="contact__map--iframe" src="{{$mapInfo->google_map_link}}" style="border: 0" allowfullscreen="" loading="lazy"></iframe>
    </div>
    @endif
@endsection
