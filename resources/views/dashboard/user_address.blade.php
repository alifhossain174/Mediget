...
@section('header_css')
    ...
    <link rel="stylesheet" href="{{url('assets')}}/css/plugins/select2.min.css" type="text/css" />
                                ...
                                <div class="address-card-head">
                                    ...
                                    <div class="address-card-head-menu dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <a class="dropdown-item editAddress"  href="javascript:void(0)" data-id="{{$address->slug}}" title="Edit" data-original-title="Edit">Edit Address</a>
