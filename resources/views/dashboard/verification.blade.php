                ...
                <div class="col-12 col-md-5 col-xl-5 col-xxl-5">
                    <div class="auth-card verifyOTP-card">
                        ...
                        <div class="auth-card-bottom">
                            ...
                            <p class="OTP-send-again m-0">
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="border: 1px solid var(--secondary-color); padding: 2px 15px; border-radius: 4px;"><i class="fi fi-rr-arrow-left" style="font-size: 12px"></i> Go Back</a>
                            </p>
                        </div>
                    </div>
                </div>
