                                ...
                                <div class="order-details-information">
                                    ...
                                    <div class="order-details-info-card-group">
                                        <div class="order-d-info-single-card">
                                            <div class="order-d-info-single-card-head">
                                                <div class="order-d-info-single-card-head-icon">
                                                    <img alt="" src="{{url('assets')}}/img/icons/user.svg" />
                                                </div>
                                        ...
                                        <div class="order-d-info-single-card">
                                            <div class="order-d-info-single-card-head">
                                                <div class="order-d-info-single-card-head-icon">
                                                    <img alt="" src="{{url('assets')}}/img/icons/track.svg" />
                                                </div>
                                                <h6 class="order-d-info-single-card-title">
                                        ...
                                        <div class="order-d-info-single-card">
                                            <div class="order-d-info-single-card-head">
                                                <div class="order-d-info-single-card-head-icon">
                                                    <img alt="#" src="{{url('assets')}}/img/icons/card-information.svg" />
                                                </div>
                                                <h6 class="order-d-info-single-card-title">
                                                    Payment information
                                                </h6>
                                        ...
                                        <div class="order-d-info-single-card">
                                            <div class="order-d-info-single-card-head">
                                                <div class="order-d-info-single-card-head-icon">
                                                    <img alt="" src="{{url('assets')}}/img/icons/note.svg" />
                                                </div>
                                                <h6 class="order-d-info-single-card-title">
                                                    Special Notes
                                                </h6>
                        ...
                        <div class="order-summary">
                            <div class="order-summary-head">
                                <h4 class="order-summary-head-title">
                                    <img alt="#" src="{{url('assets')}}/img/icons/humberger.svg" />Order summary
                                </h4>
                            </div>
